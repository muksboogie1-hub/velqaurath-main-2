            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <span className="text-[10px] font-mono px-1.5 py-0.5 rounded bg-neutral-800 text-neutral-300 border border-neutral-700">
                {fundamentalProviderStatus?.livePopulatedDimensionsCount !== undefined || fundamentalProviderStatus?.categoriesPopulatedCount !== undefined
                  ? `${fundamentalProviderStatus.livePopulatedDimensionsCount ?? fundamentalProviderStatus.categoriesPopulatedCount}/${fundamentalProviderStatus.supportedDimensionsCount ?? fundamentalProviderStatus.categoriesConfiguredCount ?? 10} Live Macro Categories Populated`
